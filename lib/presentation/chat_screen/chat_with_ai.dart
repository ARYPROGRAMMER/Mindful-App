      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
                ...
                image: NetworkImage('https://media.istockphoto.com/id/1850608258/vector/seamless-talking-speech-bubble-conversation-chatting-teamwork-gpt-background.jpg?s=612x612&w=0&k=20&c=nEB5xbclDA-FGFSVN_ttBEHiNS1IJ5NtqRAlZTWlVJI='),
                fit: BoxFit.cover
            )
        ),
        child: Column(
